...
function register_my_styles_and_scripts() {
	...
	wp_enqueue_script ( 'download_xls', THEMEROOT . '/js/min/main-min.js', array('jquery'), '2015', true);
	wp_enqueue_script( 'list_js', THEMEROOT . '/js/min/main-min.js', array(), '20151118', true);
}
