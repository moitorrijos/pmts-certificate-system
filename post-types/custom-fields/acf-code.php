...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			'key' => 'field_569e9dfbc4b28',
			'label' => 'Invoice No.',
			'name' => 'invoice_no',
			'type' => 'text',
			'instructions' => 'Add invoice No. for accounting control.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
		...
		array (
			'key' => 'field_569e9e41c4b29',
			'label' => 'Paid',
			'name' => 'paid',
			'type' => 'radio',
			'instructions' => 'Has Certificate Been Paid',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
