...
add_action( 'wp_ajax_load_certificates_by_passport', 'pmtscs_ajax_load_certificates_by_passport' );

function pmtscs_ajax_load_certificates_by_passport() {
	...
	if ( $all_certs_ids ) {
		...
		return wp_send_json( $certificate_html_list );
