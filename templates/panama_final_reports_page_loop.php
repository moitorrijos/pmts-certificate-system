<div class="main">
	...
	<div class="align-right">
		<a href="<?php echo home_url('/panama-reports/end-of-classes-report/new-final-reports/'); ?>" class="new-certificate-button not-link">
			<i class="fa fa-plus-square"></i>&nbsp; Create New End of Class Report
		</a>
	</div>
