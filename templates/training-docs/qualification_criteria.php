<div class="required-documents">
  ...
  <ol>
    ...
    <li>In the case the candidate complete the task out of the time duration will be mark as <strong>NOT DONE</strong> and should complete again the tasks, within the time duration established for each task.</li>
    <li>In case the candidate failure to do the task and out of the time duration, will be mark as <strong>NOT DONE</strong></li>
...
<h4 class="center-align">REPORT OF PRACTICAL EVALUATION CRITERIA FOR SEAFARERS PROFICIENCY &#10003;</h4>

<table class="evaluation-score passed-failed">
		<thead>
			<tr>
				<th>Competent</th>
				<th>Not Competent</th>
