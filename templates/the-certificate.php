<div class="main">
	...
	<div class="main-content">
			...
			<table class="participant-information">
				<tbody>
					<tr>
						...
						<td>
							<p>Place of Birth:</p>
							<p class="participant-info"><?php echo the_field('date_of_birth'); ?> </p>
						</td>
						<td>
							<p>Date of Birth:</p>
							<p class="participant-info"><?php echo the_field('place_of_birth'); ?></p>
						</td>
					</tr>
					<tr>
						<td>
		...
		<div class="the-test">
			...
			<h3>Test Orientation:</h3>

			<ul>
				<li>The participant has up to 55 minutes to finish this test, after which the assessor can give an extra 10 minutes to carry out if necesary.</li>
				<li>Participants are allowed to use equipments and tools mentioned bellow.</li>
				<li>Score is from 0 to 100%. 70% Minimum score to pass.</li>
			</ul>
				
			<h3>General Equipment and Tools Available:</h3>

			<ol class="general-equipment">
				<li>Computer</li>
				<li>Software</li>
				<li>Galley</li>
				<li>Nautical Chart</li>
				<li>Dividers</li>
				<li>Triangle Rules</li>
				<li>Pencil</li>
				<li>Engine Room Simulator</li>
				<li>Calculator</li>
				<li>Pen</li>
				<li>Nautical Publication</li>
				<li>Nautical Almanac</li>
				<li>Medical Care Doll and First Aid Kits</li>
				<li>Navigation Simulator</li>
			</ol>
			...
			<table>
				<thead>
					<tr>
						...
						<th class="short-title">Yes (&#x2713;)</th>
						<th class="short-title">No (&#x2717;)</th>
						<th class="middle-title">Remarks</th>
					</tr>
				</thead>
				<tbody>
					<?php for ($i = 0; $i < 8; $i++) : ?>
			...
			<table>
				<thead>
					<tr>
						<th colspan="2">Report of Practical Evaluation Criteria for Seafarers Proficiency</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="pass-fail">&#x274F; Passed</td>
						<td class="pass-fail">&#x274F; Failed</td>
					</tr>
				</tbody>
			</table>
